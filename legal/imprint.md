...
Diese App wird von einer **Privatperson** zur Verfügung gestellt. Der Anbieter handelt nicht im Rahmen einer gewerblichen oder beruflichen Tätigkeit.

Da der Anbieter als Privatperson und nicht als Unternehmen agiert, entfallen folgende sonst übliche Angaben:

- Keine USt-ID / UID-Nummer (Anbieter ist nicht mehrwertsteuerpflichtig — in der Schweiz erst ab CHF 100'000 Jahresumsatz)
- Keine Handelsregister-Eintragung
- Keine Aufsichtsbehörde
- Keine Berufsbezeichnung mit Kammer-Zugehörigkeit

## Verantwortlich für den Inhalt

Martin Schulz, Anschrift wie oben.
